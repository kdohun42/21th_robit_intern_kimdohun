...
QT_MOC_LITERAL(3, 19, 15), // "velocityUpdated"
QT_MOC_LITERAL(4, 35, 6), // "linear"
QT_MOC_LITERAL(5, 42, 7) // "angular"

    },
    "QNode\0rosShutDown\0\0velocityUpdated\0"
    "linear\0angular"
};
...
void QNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->velocityUpdated((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (QNode::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QNode::velocityUpdated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void QNode::velocityUpdated(double _t1, double _t2)
{
